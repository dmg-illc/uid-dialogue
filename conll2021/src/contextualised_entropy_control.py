...
from lm_utils import pad, ContextualisedDatasetControl
...
def compute_entropy(args, dataframe):
    ...
    data = ContextualisedDatasetControl(
        dataframe,
        tokenizer,
        max_seq_len=args.max_seq_len,
        context_field=args.context_field,
        seed=args.seed,
        size2sents_path=args.size2sents_path,
        dataframe2_path=args.control_data_path,
...
if __name__ == '__main__':
    ...
    parser.add_argument(
        "--control_data_path", type=str, required=True,
        help="The path to the input pandas dataframe."
    )
    parser.add_argument(
        "--size2sents_path", type=str, required=True,
        help="The path to the input pandas dataframe."
    )
    parser.add_argument(
